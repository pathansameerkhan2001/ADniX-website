        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {whyUsData.map((pillar) => (
            <Card
              ...
              hoverEffect
              padding="lg"
              className="border-borderGray bg-ivory-50 hover:bg-white transition-all duration-300 shadow-soft-sm hover:shadow-soft-md"
            >
              <div className="flex flex-col h-full justify-between">
                ...
                <div className="pt-4 border-t border-borderGray/60 space-y-2.5">
                  {pillar.details.map((detail, idx) => (
                    <div key={idx} className="flex items-start gap-2 text-xs sm:text-sm text-charcoal-900">
