      ...
      <Container size="xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10 xl:gap-12">
          ...
          <div className="w-full lg:w-[48%] flex flex-col items-start text-left z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-1.5 rounded-full bg-charcoal-900/90 border border-gold-500/30 text-gold-400 text-xs sm:text-sm font-semibold mb-5 sm:mb-6 shadow-soft-sm backdrop-blur-sm max-w-full">
            ...
            <h1 className="text-[clamp(32px,7.5vw,44px)] lg:text-[clamp(44px,3.8vw,54px)] font-extrabold tracking-tight text-white leading-[1.1] sm:leading-[1.12] text-balance">
              Grow Your Business.{' '}
            ...
            <p className="mt-4 sm:mt-6 text-sm sm:text-base lg:text-lg text-muted-onDark leading-relaxed max-w-xl">
            ...
            <div className="flex flex-col sm:grid sm:grid-cols-2 lg:flex lg:flex-row lg:flex-wrap items-stretch gap-2.5 sm:gap-3 mt-6 sm:mt-8 pt-6 border-t border-charcoal-800 text-xs sm:text-sm text-muted-onDark font-medium w-full">
          ...
          <div className="w-full lg:w-[50%] xl:w-[52%] flex items-center justify-center lg:justify-end shrink-0 relative pt-4 lg:pt-0">
