        ...
        <nav className="h-full flex items-center justify-between" aria-label="Main Navigation">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="md:hidden p-2.5 min-w-[48px] min-h-[48px] flex items-center justify-center rounded-xl text-charcoal-900 hover:text-gold-600 hover:bg-ivory-200 focus:outline-none focus:ring-2 focus:ring-gold-500 transition-colors"
              aria-expanded={isMenuOpen}
              aria-controls="mobile-navigation-drawer"
              aria-label={isMenuOpen ? 'Close navigation menu' : 'Open navigation menu'}
            >
              {isMenuOpen ? (
                <X className="w-6 h-6 text-charcoal-950 stroke-[2.2]" />
              ) : (
                <Menu className="w-6 h-6 text-charcoal-950 stroke-[2.2]" />
              )}
            </button>
          </div>
        </nav>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="md:hidden fixed top-[68px] sm:top-[72px] left-0 right-0 bottom-0 z-50 bg-ivory-50/98 backdrop-blur-xl border-t border-borderGray/80 shadow-soft-xl overflow-y-auto pb-safe flex flex-col"
          >
                      ...
                      <Link
                        ...
                        className={`flex items-center justify-between min-h-[52px] px-5 sm:px-6 rounded-2xl text-[18px] font-semibold leading-[1.2] text-left transition-all ${
                          isActive
                            ...
                            : 'text-charcoal-800 hover:bg-ivory-100 hover:text-charcoal-950 bg-white/70 border border-borderGray/60'
                        }`}
                      >
